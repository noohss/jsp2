			...
			<li>
				<ul style="display: flex;">
					<li>
						...
						style="resize:none;margin-right:20px;" placeholder="로그인 후에 댓글을 작성하세요." class="input"></textarea>
					</li>				
					<li style="align-self: center;margin-bottom: 20px;">
					<!-- sessionScope.user 는 session 에 저장된 애트리뷰트 user 를 가져온다.
					...
					<c:if test="${sessionScope.user == null }">	<!-- 로그인 안했을 때 -->
						<button type="button" onclick="login()" style="font-size: 0.6em;">로그인</button>
					</c:if>
					</li>				
				</ul>
			</li>
