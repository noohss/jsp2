...
<!-- 페이지 버튼을 클릭하면 url http://localhost:8080/jsp2/board/listAction.jsp 은 동일하고
	page 파라미터만 변경된다. 이런 경우 앞의 부분을 생략하고 ? 부터 작성
 -->
<div style="width:700px; margin:auto; text-align: center;">
   전채 글 개수 : <c:out value="${pagelist.totalCount }"/><br>
